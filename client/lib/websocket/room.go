...
func (c *Client) Create() error {
	if err := c.WriteMessage(Message{Type: MessageTypeCreateRoom}); err != nil {
...
func (c *Client) JoinRoom(roomID string) error {
	...
	return c.WriteMessage(Message{Type: MessageTypeJoinRoom, RoomID: c.RoomID})
}

func (c *Client) RequestPeerList() {
	if err := c.WriteMessage(Message{Type: MessageTypePeerListReq}); err != nil {
