...
func (c *Client) Create() error {
	if err := c.Send(Message{Type: common.MessageTypeCreateRoom}); err != nil {
...
func (c *Client) JoinRoom(roomID string) error {
	...
	return c.Send(Message{Type: common.MessageTypeJoinRoom, RoomID: c.RoomID})
}

func (c *Client) RequestPeerList() {
	if err := c.Send(Message{Type: common.MessageTypePeerListReq}); err != nil {
